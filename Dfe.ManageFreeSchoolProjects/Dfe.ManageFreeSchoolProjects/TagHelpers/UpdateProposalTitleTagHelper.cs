...
namespace Dfe.ManageFreeSchoolProjects.TagHelpers
{
    ...
    public class UpdateProposalTitleTagHelper : TagHelper
    {
        ...
        public UpdateProposalTitleTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var content = await _htmlHelper.PartialAsync("_UpdateProposalTitle", new CreateTitleViewModel()
            {
                Id = Id,
                Name = Name,
                Label = Label,
