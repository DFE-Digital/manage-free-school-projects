...
namespace Dfe.ManageFreeSchoolProjects.TagHelpers
{
    ...
    public class CreateProposalTitleTagHelper : TagHelper
    {
        ...
        public CreateProposalTitleTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var content = await _htmlHelper.PartialAsync("_CreateProposalTitle", new CreateTitleViewModel()
            {
                Id = Id,
                Name = Name,
                Label = Label,
