...
class GrantVariationLetterApi {
    ...
    public put(projectId: string, request: CreatePDGGrantVariationLetterRequest): Cypress.Chainable {
        return this.apiClient
            .put<
                CreatePDGGrantVariationLetterRequest,
                ResponseWrapper<never>
            >(`/api/v1/client/projects/${projectId}/grant-letters/variation-letter`, request)
            .then((response) => {
