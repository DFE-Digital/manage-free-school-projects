class EditRecruitmentAndViabilityPage {
    public withReceptionToYear6(minimumViableNumber: string, applicationsReceived: string, acceptedOffers: string) {
        this.withRow('reception-to-year6', minimumViableNumber, applicationsReceived, acceptedOffers);

        return this;
    }

    public withYear7ToYear11(minimumViableNumber: string, applicationsReceived: string, acceptedOffers: string) {
        this.withRow('year7-to-year11', minimumViableNumber, applicationsReceived, acceptedOffers);

        return this;
    }

    public withYear12ToYear14(minimumViableNumber: string, applicationsReceived: string, acceptedOffers: string) {
