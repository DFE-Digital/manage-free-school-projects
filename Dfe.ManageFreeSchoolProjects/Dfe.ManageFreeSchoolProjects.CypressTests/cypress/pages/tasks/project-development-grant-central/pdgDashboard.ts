class PdgDashboard {
    ...
    selectChangePaymentSchedule() {
        cy.getByTestId('change-payment-schedule').should('contain.text', 'Change').click();
    }
    ...
    selectViewDetailsPaymentSchedule() {
        cy.getByTestId('change-payment-schedule').should('contain.text', 'View Details').click();
    }

    selectViewDetailsGrantLetter() {
        cy.getByTestId('change-grant-letters').should('contain.text', 'View Details').click();
    }
