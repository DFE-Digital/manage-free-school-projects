...
class TrustSummaryPage {
    public verifyTrustSummaryElementsVisible(): this {
        ...
        summaryPage
            .inOrder()
            .summaryShows('TRN (trust reference number)')
            .HasValue('TR90111')
            .HasChangeLink()
            .summaryShows('Trust name')
            .HasValue('The James Web School')
            .HasNoChangeLink()
            .summaryShows('Trust type')
            .HasValue('SAT (single academy trust)')
            .HasNoChangeLink();
    ...
    public verifyTrustSummaryCompleteElementsVisible(validTrustId: string): this {
        ...
        summaryPage
            .inOrder()
            .summaryShows('TRN (trust reference number)')
            .HasValue(validTrustId)
            .HasChangeLink()
            .summaryShows('Trust name')
            .HasValue('Neat Idea Trust')
            .HasNoChangeLink()
            .summaryShows('Trust type')
            .HasValue('MAT')
            .HasNoChangeLink();
