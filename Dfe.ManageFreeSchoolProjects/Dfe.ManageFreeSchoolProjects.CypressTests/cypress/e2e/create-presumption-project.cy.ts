...
describe('Testing the presumption route project creation journey', () => {
    ...
    describe('Creating an individual project - Create a Presumption route new project', () => {
        ...
        it('Should create a project', () => {
            ...
            createProjectPage.continue().errorMessage('Select what project you want to create');

            cy.executeAccessibilityTests();

            createProjectPage.selectOption('Presumption').continue();
            ...
            createProjectPage.enterProjectId(temporaryProjectId).continue();
            ...
            createProjectPage.enterSchoolName(schoolName).continue();

            createProjectPage.titleIs('What is the region of the school?').continue().errorMessage('Select the region');

            cy.executeAccessibilityTests();

            Logger.log('Select East of England');
            createProjectPage.selectOption('East of England').continue();
            ...
            createProjectPage.selectOption('Luton').continue();
            ...
            createProjectPage.enterTRN(TestTrn).continue();
            ...
            createProjectPage.titleIs('What is the school type?').continue().errorMessage('Select the school type');

            cy.executeAccessibilityTests();

            Logger.log('Selecting Mainstream school type');
            createProjectPage.selectOption('Mainstream').continue();
            ...
            createProjectPage.titleIs('What is the school phase?').continue().errorMessage('Select the school phase');

            cy.executeAccessibilityTests();

            Logger.log('Selecting Secondary school phase');
            createProjectPage.selectOption('Secondary').continue();
            ...
            createProjectPage.enterAgeRangeFrom('2').enterAgeRangeTo('7').continue();
            ...
            createProjectPage.titleIs('What is the faith status?').continue().errorMessage('Select the faith status');

            cy.executeAccessibilityTests();

            Logger.log('Select Designation');
            createProjectPage.selectOption('Designation').continue();
            ...
            createProjectPage.selectOption('Greek Orthodox').continue();
            ...
            createProjectPage.setProvisionalOpeningDate('1', '10', '2035').continue();
            ...
            summaryPage
                ...
                .HasValue('Presumption')
                .HasChangeLink()
                .summaryShows('Temporary project ID')
                .HasValue(temporaryProjectId)
                .HasChangeLink()
                .summaryShows('Current free school name')
                .HasValue(schoolName)
                .HasChangeLink()
                .summaryShows('Region')
                .HasValue('East of England')
                .HasChangeLink()
                .summaryShows('Local authority')
                .HasValue('Luton')
                .HasChangeLink()
                .summaryShows('Trust')
                .HasValue('The James Web School')
                .HasChangeLink()
                .summaryShows('School type')
                .HasValue('Mainstream')
                .HasChangeLink()
                .summaryShows('Nursery')
                .HasValue('Yes')
                .HasChangeLink()
                .summaryShows('Sixth form')
                .HasValue('Yes')
                .HasChangeLink()
                .summaryShows('Residential or boarding')
                .HasValue('Yes')
                .HasChangeLink()
                .summaryShows('Alternative provision')
                .HasValue('Yes')
                .HasChangeLink()
                .summaryShows('Special educational needs')
                .HasValue('No')
                .HasChangeLink()
                ...
                .HasValue('2 to 7')
                .HasChangeLink()
                .summaryShows('Nursery capacity')
                .HasValue('200')
                .HasChangeLink()
                .summaryShows('Reception to year 6 capacity')
                .HasValue('0')
                .HasChangeLink()
                .summaryShows('Year 7 to year 11 capacity')
                .HasValue('400')
                .HasChangeLink()
                .summaryShows('Year 12 to year 14 capacity')
                .HasValue('150')
                .HasChangeLink()
                .summaryShows('Faith status')
                .HasValue('Designation')
                .HasChangeLink()
                .summaryShows('Faith type')
                .HasValue('Greek Orthodox')
                .HasChangeLink()
                .summaryShows('Provisional opening date')
                .HasValue('1 October 2035')
                .HasChangeLink()
                .summaryShows('Project assigned to')
                .HasValue('joe bloggs')
                .HasChangeLink()
                .summaryShows('Email')
                .HasValue('test.person@education.gov.uk')
                .HasChangeLink();
            ...
            createProjectPage
                .hasConfirmedProjectId(temporaryProjectId)
        ...
        it('Should navigate back to change project fields', () => {
            ...
            createProjectPage.titleIs('Confirm the trust').selectOption('Yes').continue();
            ...
            Logger.log('Select Designation');
            createProjectPage.selectOption('None').continue();
            ...
            createProjectPage.hasProjectId(temporaryProjectId).enterProjectId(updatedTemporaryProjectId).continue();
            ...
            createProjectPage.hasSchoolName(schoolName).enterSchoolName(updatedSchoolName).continue();
            ...
            createProjectPage.isOptionChecked('Camden').selectOption('Hackney').continue();
            ...
            createProjectPage.hasNursery('No').hasSixthForm('Yes').setSixthFormTo('No').setNurseryTo('Yes').continue();
            summaryPage.SummaryHasValue('Sixth form', 'No').SummaryHasValue('Nursery', 'Yes');

            Logger.log('Change residential or boarding');
            summaryPage.clickChangeFor('Residential or boarding');
            createProjectPage.setResidentialOrBoarding('No').continue();
            summaryPage.SummaryHasValue('Residential or boarding', 'No');

            Logger.log('Change Nursery');
            summaryPage.clickChangeFor('Nursery');
            createProjectPage.setSixthFormTo('Yes').setNurseryTo('No').continue();
            summaryPage.SummaryHasValue('Sixth form', 'Yes').SummaryHasValue('Nursery', 'No');

            Logger.log('Change Alternative provision');
            summaryPage.clickChangeFor('Alternative provision');
            createProjectPage.setAlternativeProvisionTo('Yes').continue();
            summaryPage.SummaryHasValue('Alternative provision', 'Yes');

            Logger.log('Change Special educational needs');
            summaryPage.clickChangeFor('Special educational needs');
            createProjectPage.setSpecialEducationNeedsTo('No').continue();
            summaryPage.SummaryHasValue('Special educational needs', 'No');

            Logger.log('Change School phase');
            summaryPage.clickChangeFor('School phase');
            createProjectPage.isOptionChecked('Secondary').selectOption('All-through').continue();
            summaryPage.SummaryHasValue('School phase', 'All-through');
            ...
            createProjectPage
                ...
                .enterAgeRangeTo('11')
                .continue();
            summaryPage.SummaryHasValue('Age range', '4 to 11');

            Logger.log('Change School type');
            summaryPage.clickChangeFor('School type');
            createProjectPage.isOptionChecked('Mainstream').selectOption('Special').continue().continue();
            summaryPage
            ...
            summaryPage.SummaryHasValue('Faith status', 'Ethos').SummaryHasValue('Faith type', 'Roman Catholic');
            ...
            createProjectPage
                ...
                .continue();
            summaryPage
                .SummaryHasValue('Faith status', 'Designation')
            ...
            createProjectPage
                ...
                .continue();
            summaryPage.SummaryHasValue('Provisional opening date', '12 November 2034');
            ...
            createProjectPage.enterProjectAssignedToEmail('anne.jones@education.gov.uk').continue();
            summaryPage
            ...
            Logger.log('Confirm created');
            createProjectPage
                .hasConfirmedProjectId(updatedTemporaryProjectId)
