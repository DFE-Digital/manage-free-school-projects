    ...
    describe('Editing Contacts', () => {
        it('Should be able to edit Project assigned to', () => {
            ...
            editProjectAssignedToPage
                ...
                .clickContinue()
                .errorForProjectAssignedToName(
                    'Project assigned to name must not include special characters other than , ( )'
                )
                .withProjectAssignedToName('da')
                .clickContinue()
                ...
                .clickContinue()
                .errorForProjectAssignedToEmail(
                    'Email address must be in the format firstname.surname@education.gov.uk'
                )
        ...
        it('Should be able to edit Team lead', () => {
            ...
            contactsPage.hasTeamLeadName('Test Person').hasTeamLeadEmail('test.person@education.gov.uk');
        });
        ...
        it('Should be able to edit Grade 6', () => {
            ...
            contactsPage.hasGrade6Name('Test Person').hasGrade6Email('test.person@education.gov.uk');
        });
        ...
        it('Should be able to edit Project manager', () => {
            ...
            editProjectManagerPage
                ...
                .clickContinue()
                .errorForProjectManagerEmail(
                    'Enter an email address in the correct format, like firstname.surname@outlook.com'
                )
            ...
            contactsPage.hasProjectManagerName('Test Person').hasProjectManagerEmail('test.person@gmail.com');
        });
        ...
        it('Should be able to edit Project director', () => {
            ...
            editProjectDirectorPage
                ...
                .clickContinue()
                .errorForProjectDirectorName(
                    'Project director name must not include special characters other than , ( )'
                )
                .withProjectDirectorName('da')
                .clickContinue()
            ...
            contactsPage.hasProjectDirectorName('Test Person').hasProjectDirectorEmail('test.person@gmail.com');
        });
        ...
        it('Should be able to edit Principal designate', () => {
            ...
            editPrincipalDesignatePage
                ...
                .clickContinue()
                .errorForPrincipalDesignateName(
                    'Principal designate name must not include special characters other than , ( )'
                )
                .withPrincipalDesignateName('da')
                .clickContinue()
                ...
                .clickContinue()
                .errorForPrincipalDesignateEmail(
                    'Enter an email address in the correct format, like firstname.surname@outlook.com'
                )
            ...
            contactsPage.hasPrincipalDesignateName('Test Person').hasPrincipalDesignateEmail('test.person@gmail.com');
        });
    });
});
