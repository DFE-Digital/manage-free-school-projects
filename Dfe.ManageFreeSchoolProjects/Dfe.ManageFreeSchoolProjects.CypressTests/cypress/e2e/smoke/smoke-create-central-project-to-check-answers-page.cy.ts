...
describe('Smoke Test Create an individual Central project - (Up Until Check your answers Page)', () => {
    ...
    it('Should create a central project up until Check your answers page', { tags: ['smoke'] }, () => {
        ...
        createProjectPage.selectOption('Central').continue();
        ...
        createProjectPage.titleIs('What is the application wave?').enterApplicationWave(applicationWave).continue();
        ...
        createProjectPage.titleIs('What is the local authority?').continue().errorMessage('Select the local authority');
        ...
        createProjectPage.titleIs('Confirm the trust').continue().errorMessage('Select yes if the trust is correct');
        ...
        createProjectPage.titleIs('What is the school phase?').selectOption('Secondary').continue();
        ...
        summaryPage
            ...
            .HasValue('Central')
            .HasChangeLink()
            .summaryShows('Application number')
            .HasValue(applicationNumber)
            .HasChangeLink()
            .summaryShows('Application wave')
            .HasValue(applicationWave)
            .HasChangeLink()
        ...
        summaryPage.createProjectbutton('Create project');
