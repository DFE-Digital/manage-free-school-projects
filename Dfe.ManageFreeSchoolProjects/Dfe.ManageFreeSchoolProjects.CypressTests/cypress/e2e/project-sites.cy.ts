...
describe('Testing the setting up of project sites - presumption route', () => {
    ...
    it('Should be able to configure the project sites', () => {
        ...
        projectOverviewPage.selectSiteInformationTab();
        ...
        viewSiteInformationPresumptionPage.changeTemporarySite();
        ...
        viewSiteInformationPresumptionPage
            .hasPermanentSiteAddress(
                'Alternative permanent site',
                'Alternative permanent street',
                'Alternative permanent town'
            )
            ...
            .hasTemporarySiteAddress(
                'Alternative temporary site',
                'Alternative temporary street',
                'Alternative temporary town'
            )
