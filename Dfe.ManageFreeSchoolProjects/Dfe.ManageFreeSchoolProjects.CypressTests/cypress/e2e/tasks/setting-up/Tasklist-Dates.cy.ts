...
describe('Testing project overview', () => {
    ...
    it('Should successfully set project dates', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('Dates').clickChangeProjectStatus();

        projectStatusPage.selectCancelled().clickSaveAndContinue();
        ...
        taskListPage.isTaskStatusIsNotStarted('Dates').selectDatesFromTaskList();
        ...
        summaryPage
            ...
            .titleIs('Dates')
            .inOrder()
            .summaryShows('Date the project was cancelled')
            .HasValue('2000')
            .HasChangeLink()
            .summaryShows('Entry into pre-opening')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Realistic year of opening')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Provisional opening date agreed with trust')
            .IsEmpty()
            .HasChangeLink()
        ...
        datesDetailsPage.titleIs('Edit Dates').schoolNameIs(project.schoolName).clickContinue();
        ...
        summaryPage
            .inOrder()
            .summaryShows('Date the project was cancelled')
            .HasValue('12 February 2049')
            .HasChangeLink()
            .summaryShows('Entry into pre-opening')
            .HasValue('10 August 2025')
            .HasChangeLink()
            .summaryShows('Realistic year of opening')
            .HasValue('2040/41')
            .HasChangeLink()
            .summaryShows('Provisional opening date agreed with trust')
            .HasValue('12 September 2026')
            .HasChangeLink()
            .clickChange();
        ...
        summaryPage
            ...
            .HasChangeLink()
            .summaryShows('Entry into pre-opening')
            .HasValue('11 August 2026')
            .HasChangeLink()
            .summaryShows('Realistic year of opening')
            .HasValue('2040/41')
            .HasChangeLink()
            .summaryShows('Provisional opening date agreed with trust')
            .HasValue('13 September 2027')
            .HasChangeLink();
    ...
    it('Should show validation errors on date fields', () => {
        ...
        Logger.log('Selecting Dates link from Tasklist');
        datesDetailsPage.titleIs('Dates').schoolNameIs(project.schoolName);
