...
describe('Testing Constituency Task', () => {
    ...
    it('Should successfully set constituency', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('Constituency').selectConstituencyFromTaskList();
        ...
        taskListPage.isTaskStatusInProgress('Constituency').selectConstituencyFromTaskList();
        ...
        constituencySearchPage.enterSearch('SW1P').clickContinue();
        ...
        constituencySearchPage.enterSearch('Potato').clickContinue();

        cy.executeAccessibilityTests();

        constituencyEditPage.schoolNameIs(project.schoolName).titleIs('0 results for Potato').clickSearchAgain();
