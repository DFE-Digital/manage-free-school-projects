...
describe('Testing project overview', () => {
    ...
    const newProjectId: string = dataGenerator.generateTemporaryId(20);
    ...
    it('Should be able to edit reference numbers', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('ReferenceNumbers').selectReferenceNumbersFromTaskList();
        ...
        taskListPage.isTaskStatusInProgress('ReferenceNumbers').selectReferenceNumbersFromTaskList();
        ...
        referenceNumbersDetailsPage
            ...
            .clickContinue()
            .errorForProjectId()
            .showsError('Enter the project ID')
            .withProjectId(newProjectId + '-')
            .clickContinue()
            .errorForProjectId()
            .showsError('Project ID must only include numbers and letters')
            .withProjectId(newProjectId + ' a')
            .clickContinue()
            .errorForProjectId()
            .showsError('Project ID must not include spaces')
            .withProjectId(dataGenerator.generateAlphaNumeric(26))
            .clickContinue()
            .errorForProjectId()
            .showsError('Project ID must be 25 characters or less')
            .withProjectId(existingProject.projectId)
            .clickContinue()
            .errorForProjectId()
            .showsError('Project ID already exists');

        cy.log('Fill in valid project id without urn');

        referenceNumbersDetailsPage.withProjectId(newProjectId).clickContinue();
        ...
        referenceNumbersDetailsPage
            ...
            .clickContinue()
            .errorForUrn()
            .showsError('URN must be 6 numbers, like 123456')
            .withUrn('65753')
            .clickContinue()
            .errorForUrn()
            .showsError('URN must be 6 numbers, like 123456')
        ...
        taskListPage.selectReferenceNumbersFromTaskList();
