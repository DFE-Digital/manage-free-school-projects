...
describe('Write off Task', () => {
    ...
    it('Should successfully set Write off', () => {
        ...
        writeOff.titleIs('Edit Write-off').schoolNameIs(project.schoolName).withIsWriteOff('Yes').clickContinue();
        ...
        summaryPage
            ...
            .summaryShows('Is there any write-off?')
            .HasValue('Yes')
            .summaryShows('Write-off reason')
            .IsEmpty()
            .summaryShows('Write-off amount')
            .IsEmpty()
            .summaryShows('Write-off date')
            .IsEmpty()
            .summaryShows('Finance business partner approval received from')
            .IsEmpty()
        ...
        writeOff
            ...
            .clickContinue()
            .errorForWriteOffAmount()
            .showsError('Write-off amount must be two decimal places');
        ...
        writeOff
            ...
            .clickContinue()
            .errorForWriteOffReason()
            .showsError("Write-off reason must not include special characters other than , ( ) '");
        ...
        writeOff
            ...
            .clickContinue()
            .errorForFinanceBusinessPartnerApproval()
            .showsError(
                "Finance business partner approval received from must not include special characters other than , ( ) '"
            );
        ...
        summaryPage
            ...
            .HasValue('299.04')
            .summaryShows('Write-off date')
            .HasValue('4 December 2025')
            .summaryShows('Finance business partner approval received from')
            .HasValue('Sam Smigel')
            .summaryShows('Approval date')
            .HasValue('5 December 2025')
            .MarkAsComplete()
