...
describe('Trust Letter Sent Task', () => {
    ...
    it('Should successfully set trust letter', () => {
        ...
        summaryPage
            ...
            .inOrder()
            .skip(6)
            .summaryShows('Date when DfE signed PDG letter sent to the trust')
            .IsEmpty()
            .summaryShows('Saved the signed trust letter in Workplaces folder')
            .IsEmpty()
        ...
        trustLetter.titleIs('Edit Trust letter').schoolNameIs(project.schoolName).clickContinue();
        ...
        trustLetter.withTrustLetterDate('1', '2', '2021').checkSavedInWorkplaces().clickContinue();
