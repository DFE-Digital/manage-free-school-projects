...
describe('Testing Principal designate task', () => {
    ...
    it('Should be able to set a Principal designate', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('PrincipalDesignate').selectPrincipleDesignateFromTaskList();
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Commissioned an external expert')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Expected date that principal designate will be appointed')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Principal designate appointed')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Actual date that principal designate was appointed')
            .IsEmpty()
            .HasChangeLink()
        ...
        taskListPage.isTaskStatusInProgress('PrincipalDesignate').selectPrincipleDesignateFromTaskList();

        summaryPage.clickChange();

        cy.log('Check empty values accepted');

        editPrincipalDesignatePage.clickContinue();
        ...
        editPrincipalDesignatePage
            ...
            .clickContinue()
            .errorForPrincipleDesignateAppointedDate()
            .showsError('Actual date that principal designate was appointed must include a month and year')
            .withPrincipleDesignateAppointedDate('24', '4', '')
            .clickContinue()
            .errorForPrincipleDesignateAppointedDate()
            .showsError('Actual date that principal designate was appointed must include a year')
        ...
        editPrincipalDesignatePage
            ...
            .clickContinue()
            .errorForExpectedPrincipleDesignateAppointedDate()
            .showsError('Expected date that principal designate will be appointed must include a month and year')
            .withExpectedPrincipleDesignateAppointedDate('25', '4', '')
            .clickContinue()
            .errorForExpectedPrincipleDesignateAppointedDate()
            .showsError('Expected date that principal designate will be appointed must include a year')
        ...
        summaryPage.clickChange();
        //
        editPrincipalDesignatePage.checkNoForPrincipleDesignate().checkNotApplicableForExternalExpert().clickContinue();
