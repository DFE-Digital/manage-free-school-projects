...
import statutoryConsultationtEditPage from '../../../pages/tasks/pre-opening/edit-statutory-consultation';
...
describe('Testing statutory consultation', () => {
    ...
    it('Should successfully set statutory consultation task', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('StatutoryConsultation').selectStatutoryConsultationFromTaskList();
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Expected date for receiving findings from trust')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Received consultation findings from trust')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Date received')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows("Consultation fulfils the trust's section 10 statutory duty")
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Comments')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved findings in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
        ...
        taskListPage.isTaskStatusInProgress('StatutoryConsultation').selectStatutoryConsultationFromTaskList();
        ...
        statutoryConsultationtEditPage.schoolNameIs(project.schoolName);
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Expected date for receiving findings from trust')
            .HasValue('2 March 2020')
            .summaryShows('Received consultation findings from trust')
            .HasValue('Yes')
            .summaryShows('Date received')
            .HasValue('4 March 2020')
            .summaryShows("Consultation fulfils the trust's section 10 statutory duty")
            .HasValue('Yes')
            .summaryShows('Comments')
            .HasValue('This is a comment')
            .summaryShows('Saved findings in Workplaces folder')
            .HasValue('Yes')
            .isNotMarkedAsComplete();
        ...
        summaryPage
            ...
            .HasValue('Yes')
            .summaryShows('Date received')
            .HasValue('3 March 2020')
            .summaryShows("Consultation fulfils the trust's section 10 statutory duty")
            .HasValue('Yes')
            .summaryShows('Comments')
            .HasValue('This is a new comment')
            .summaryShows('Saved findings in Workplaces folder')
            .HasValue('Yes')
            .isNotMarkedAsComplete();
