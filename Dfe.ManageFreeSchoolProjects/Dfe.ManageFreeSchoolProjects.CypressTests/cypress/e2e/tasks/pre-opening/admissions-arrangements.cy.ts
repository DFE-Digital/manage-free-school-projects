...
describe('Testing the admissions arragements task', () => {
    ...
    it('Should be able to set admissions arrangements', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('AdmissionsArrangements').selectAdmissionsArrangementsFromTaskList();

        summaryPage
            .schoolNameIs(project.schoolName)
            .titleIs('Admissions arrangements')
            .inOrder()
            .summaryShows('Expected date that trust will confirm arrangements')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows(
                'Trust has confirmed they developed their admissions arrangements using the recommended template'
            )
            .IsEmpty()
            .HasChangeLink()
            .summaryShows(
                'Trust has confirmed their arrangements comply with the School Admissions Code and School Admission Appeals Code'
            )
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Actual date that trust confirmed arrangements')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved the confirmation email in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
