...
describe('Testing pre-funding agreement checkpoint meeting task', () => {
    ...
    it('Should be able to set pre-funding agreement checkpoint meeting', () => {
        ...
        taskListPage
            .isTaskStatusIsNotStarted('PreFundingAgreementCheckpointMeeting')
        ...
        summaryPage
            ...
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved the meeting note in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows(
                'Sent an email to the trust highlighting any significant concerns and necessary actions (if applicable)'
            )
            .IsEmpty()
            .HasChangeLink()
        ...
        preFundingAgreementCheckpointMeetingEditPage.clickContinue();
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Type of meeting held')
            .HasValue('Formal checkpoint meeting')
            .HasChangeLink()
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Type of meeting held')
            .HasValue('Internal review / case conference')
            .HasChangeLink()
            .summaryShows('Date of the meeting')
