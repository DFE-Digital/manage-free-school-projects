...
describe('Testing finance plan task', () => {
    ...
    it('Should be able to set a finance plan', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('FinancePlan').selectFinancePlanFromTaskList();
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Finance plan agreed')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Date agreed')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Plan saved in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Local authority agreed to underwrite pupil numbers')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Trust will opt-in to RPA (risk protection arrangement)')
            .IsEmpty()
            .HasChangeLink()
        ...
        editFinancePlanPage.titleIs('Edit Finance plan').schoolNameIs(project.schoolName).clickContinue();
        ...
        summaryPage
            ...
            .summaryShows('Trust will opt-in to RPA (risk protection arrangement)')
            .HasValue('Yes')
            .summaryShows(rpaStartDateLabel)
            .HasValue('12 September 2025')
            .summaryShows(rpaCoverTypeLabel)
            .HasValue('Comprehensive');
        ...
        validationComponent.hasValidationError('Add comments about underwritten places must be 500 characters or less');

        editUnderwrittenPlacesPage.withComments('Some comments').clickContinue();

        Logger.log('Should show underwritten places');
        summaryPage
            .startFromRow(4)
            .summaryShows('Number of underwritten primary places')
            .HasValue('First year of opening: 111')
            .startFromRow(4)
            .summaryShows('Number of underwritten primary places')
            .HasValue('Third year of opening: 222')
            .startFromRow(4)
            .summaryShows('Number of underwritten primary places')
            .HasValue('Seventh year of opening: 333')
            .skip(2)
            .summaryShows('Confirmation from local authority saved in workplaces folder')
            .HasValue('Yes')
            .summaryShows('Comments about underwritten places')
            .HasValue('Some comments');
