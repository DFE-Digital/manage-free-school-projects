...
describe('Testing Funding agreement submission Task', () => {
    ...
    it('Should successfully set funding agreement submission task', () => {
        ...
        taskListPage
            .isTaskStatusIsNotStarted('FundingAgreementSubmission')
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Drafted a funding agreement (FA) submission')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Regional Director has signed-off the FA submission (if applicable)')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Minister has signed-off the FA submission (if applicable)')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Included a signed-off impact assessment in the submission')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved the submission in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
        ...
        taskListPage
            .isTaskStatusInProgress('FundingAgreementSubmission')
            .selectFundingAgreementSubmissionFromTaskList();
        ...
        taskListPage.selectFundingAgreementSubmissionFromTaskList();
