...
describe('Testing the ofsted pre registration', () => {
    ...
    it('Should be able to set impact assessment', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('OfstedInspection').selectOfstedPreregistrationFromTaskList();

        summaryPage
            .schoolNameIs(project.schoolName)
            .titleIs('Ofsted pre-registration')
            .inOrder()
            .summaryShows('Provided the trust with details about the process')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Decided on the inspection block')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Confirmed contact details for Ofsted and the trust to liaise with each other')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Added the block and contact details to openers spreadsheet')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Shared the outcome with the trust')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Any actions to meet conditions have been completed')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Date that inspection and any actions were completed')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows("Requested that the school is changed to 'proposed to open' on GIAS")
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved inspection documents and G6 agreement in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
        ...
        beforeInspectionEditPage.clickContinue();
        ...
        afterInspectionEditPage.clickContinue();
        ...
        taskListPage.selectOfstedPreregistrationFromTaskList();
