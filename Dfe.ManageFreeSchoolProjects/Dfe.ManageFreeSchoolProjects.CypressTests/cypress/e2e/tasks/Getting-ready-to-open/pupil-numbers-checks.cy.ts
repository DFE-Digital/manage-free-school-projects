...
describe('Testing the pupil numbers checks task', () => {
    ...
    it('Should be able to set pupil numbers checks', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('PupilNumbersChecks').selectPupilNumbersChecksTaskList();

        summaryPage
            .schoolNameIs(project.schoolName)
            .titleIs('Pupil numbers checks')
            .inOrder()
            .summaryShows('School has received enough applications to be viable')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows("Capacity data matches what's on the funding agreement")
            .IsEmpty()
            .HasChangeLink()
            .summaryShows("Capacity data matches what's on the GIAS registration form")
            .IsEmpty()
            .HasChangeLink()
        ...
        pupilNumbersChecksEditPage.clickContinue();
