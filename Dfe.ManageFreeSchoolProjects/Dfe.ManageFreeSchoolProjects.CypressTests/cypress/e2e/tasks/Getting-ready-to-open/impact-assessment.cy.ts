...
describe('Testing the impact assessment task - presumption route', () => {
    ...
    it('Should be able to set impact assessment', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('ImpactAssessment').selectImpactAssessmentFromTaskList();

        summaryPage
            .schoolNameIs(project.schoolName)
            .titleIs('Impact assessment')
            .inOrder()
            .summaryShows('Conducted the impact assessment')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved the signed-off impact assessment in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
        ...
        impactAssessmentEditPage.clickContinue();
        ...
        impactAssessmentEditPage.checkImpactAssessmentDone().checkSavedToWorkplaces().clickContinue();
        ...
        impactAssessmentEditPage.uncheckImpactAssessmentDone().uncheckSavedToWorkplaces().clickContinue();
...
describe('Testing the impact assessment task - central route', () => {
    ...
    it('Should include section 9 letter wording for saved in workplaces label', () => {
        ...
        summaryPage
            ...
            .titleIs('Impact assessment')
            .inOrder()
            .summaryShows('Sent the section 9 letter to local authority')
            .HasValue('No')
            .HasChangeLink()
            .summaryShows('Date sent')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Conducted the impact assessment')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Saved the section 9 letter and signed-off impact assessment in Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
            .isNotMarkedAsComplete();
