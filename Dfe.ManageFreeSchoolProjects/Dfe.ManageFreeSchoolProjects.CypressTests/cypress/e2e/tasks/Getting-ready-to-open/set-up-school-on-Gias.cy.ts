...
describe('Testing gias', () => {
    ...
    it('Should successfully set gias task', () => {
        cy.log('Select gias');
        taskListPage.isTaskStatusIsNotStarted('Gias').selectGiasFromTaskList();
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows("Check the information on trusts' completed GIAS application form is correct")
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Send the application form to the Ofstedpre-reg.FreeSchools@education.gov.uk mailbox')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Save a copy of the application form in Workplaces')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Send the trust their URN and DfE establishment number')
            .IsEmpty()
            .HasChangeLink()
        ...
        taskListPage.isTaskStatusInProgress('Gias').selectGiasFromTaskList();
        ...
        taskListPage.selectGiasFromTaskList();
