...
describe('Testing the moving to open task', () => {
    ...
    it('Should be able to set moving to open', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('MovingToOpen').selectMovingToOpenFromTaskList();
        ...
        summaryPage
            ...
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Actual opening date')
            .IsEmpty()
            .HasChangeLink()
        ...
        movingToOpenEditPage.clickContinue();
        ...
        summaryPage
            ...
            .inOrder()
            .summaryShows('Sent the project brief to')
            .HasValue('SFSO (Schools Financial Support and Oversight)')
            .HasChangeLink()
            .HasValue('Education Estates')
            .HasChangeLink()
            .HasValue('New delivery officer')
            .HasChangeLink()
            .summaryShows('Sent emails to')
            .HasValue("The school's principal about handing project over to SFSO")
            .HasChangeLink()
            .HasValue('Relevant contacts to confirm school is moving to open')
            .HasChangeLink()
            .summaryShows('Saved documents in moving to open Workplaces folder')
            .HasValue('Project brief')
            .HasChangeLink()
            .HasValue('Annex B checklist documents')
            .HasChangeLink()
            .HasValue('Completed Annex E checklist')
            .HasChangeLink()
            .summaryShows('Actual opening date')
            .HasValue('30 December 2050')
            .HasChangeLink()
            .isNotMarkedAsComplete()
        ...
        summaryPage
            ...
            .HasValue('Education Estates')
            .HasChangeLink()
            .DoesNotHaveValue('New delivery officer')
            .HasChangeLink()
            .summaryShows('Sent emails to')
            .HasValue("The school's principal about handing project over to SFSO")
            .HasChangeLink()
            .DoesNotHaveValue('Relevant contacts to confirm school is moving to open')
            .HasChangeLink()
            .summaryShows('Saved documents in moving to open Workplaces folder')
            .IsEmpty()
            .HasChangeLink()
            .summaryShows('Actual opening date')
            .HasValue('29 December 2050')
            .HasChangeLink()
            .isNotMarkedAsComplete()
            .MarkAsComplete()
            .clickConfirmAndContinue();
