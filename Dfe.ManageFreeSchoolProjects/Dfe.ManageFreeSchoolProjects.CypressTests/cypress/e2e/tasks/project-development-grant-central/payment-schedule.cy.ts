...
describe('Payment Schedule Task', () => {
    ...
    it('Should successfully set payment schedule', () => {
        ...
        taskListPage.isTaskStatusIsNotStarted('PDG').selectPDGFromTaskList();
        ...
        summaryPage
            ...
            .IsEmpty()
            .summaryShows('Amount sent')
            .IsEmpty()
            .summaryShows('Due amount')
            .IsEmpty()
            .summaryShows('Total amount')
            .IsEmpty()
            .summaryShows('Number of scheduled payments')
            .HasValue('0')
        ...
        taskListPage.isTaskStatusInProgress('PDG').selectPDGFromTaskList();
        ...
        addPayment.titleIs('Add a payment').schoolNameIs(project.schoolName).clickDiscard();
        ...
        paymentSchedule.schoolNameIs(project.schoolName).checkPaymentAdded('1').selectEditPayment('1');
        ...
        editPayment
            ...
            .clickContinue()
            .errorForPaymentDueDate()
            .showsError('Day must be a number, like 12')
            .withPaymentDueDate(paymentDate.day, paymentDate.month, paymentDate.year)

            .withPaymentDueAmount('a')
            .clickContinue()
            .errorForPaymentDueAmount()
            .showsError('Due amount must be a number')
            .withPaymentDueAmount('-1')
            .clickContinue()
            .errorForPaymentDueAmount()
            .showsError('Due amount must be between 0 and 640000')
            .withPaymentDueAmount('250.256')
            .clickContinue()
            .errorForPaymentDueAmount()
            .showsError('Due amount must be two decimal places')
            ...
            .clickContinue()
            .errorForPaymentActualDate()
            .showsError('Day must be a number, like 12')
            .withPaymentActualDate(paymentDate.day, paymentDate.month, paymentDate.year)

            .withPaymentActualAmount('a')
            .clickContinue()
            .errorForPaymentActualAmount()
            .showsError('Actual amount must be a number')
            .withPaymentActualAmount('-1')
            .clickContinue()
            .errorForPaymentActualAmount()
            .showsError('Actual amount must be between 0 and 640000')
            .withPaymentActualAmount('250.256')
            .clickContinue()
            .errorForPaymentActualAmount()
            .showsError('Actual amount must be two decimal places')
        ...
        paymentSchedule.schoolNameIs(project.schoolName).checkPaymentUpdated('1').selectAddPayment();
        ...
        addPayment
            ...
            .clickContinue()
            .errorForPaymentActualAmount()
            .showsError('Amount sent must be a number')
            .withPaymentActualAmount('-1')
            .clickContinue()
            .errorForPaymentActualAmount()
            .showsError('Amount sent must be between 0 and 640000')
            .withPaymentActualAmount('250.256')
            .clickContinue()
            .errorForPaymentActualAmount()
            .showsError('Amount sent must be two decimal places')
        ...
        const nextPaymentDate = paymentDate.plus({ days: 28 });

        for (let i = 3; i <= 12; i++) {
            paymentDate = paymentDate.plus({ days: 28 });

            paymentSchedule.selectAddPayment();
            addPayment
                .titleIs('Add a payment')
                .schoolNameIs(project.schoolName)
                .withPaymentDueDate(paymentDate.day, paymentDate.month, paymentDate.year)
            ...
            paymentSchedule.schoolNameIs(project.schoolName).checkPaymentAdded(i.toString());
        }

        paymentSchedule.checkAddPaymentDoesNotExist();

        paymentSchedule.selectEditPayment('1');

        editPayment.titleIs('Edit Payment 1').schoolNameIs(project.schoolName).clickDelete();

        cy.executeAccessibilityTests();

        deletePayment.clickNo();

        paymentSchedule.schoolNameIs(project.schoolName).selectEditPayment('1');

        editPayment.titleIs('Edit Payment 1').schoolNameIs(project.schoolName).clickDelete();

        deletePayment.clickDelete();

        paymentSchedule.schoolNameIs(project.schoolName).checkPaymentDeleted().checkAddPaymentDoesExist();

        paymentSchedule.clickBack();

        summaryPage
            .startFromRow(4)
            .summaryShows('Number of scheduled payments')
            .HasValue('11')
            .summaryShows('Number of sent payments')
            .HasValue('1')
            .summaryShows('Next payment due date')
            .HasValue(nextPaymentDate.toFormat('d MMMM yyyy'))
            .summaryShows('Next due amount')
            .HasValue('£5,000')
            .summaryShows('Amount sent')
            .HasValue('£4,000');
