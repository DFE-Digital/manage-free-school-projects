...
describe('Refunds Task', () => {
    ...
    it('Should successfully set refunds', () => {
        ...
        refunds.titleIs('Edit Refunds').schoolNameIs(project.schoolName).clickContinue();
        ...
        refunds
            ...
            .clickContinue()
            .errorForTotalAmount()
            .showsError('Total amount must be two decimal places');

        cy.log('Confirm all set');
        refunds.withLatestRefundDate('5', '12', '2025').withTotalAmount('250.25').clickContinue();

        summaryPage.inOrder().skip(7).summaryShows('Latest refund date').summaryShows('Total amount');
